...
def main():
    st.set_page_config("Android Chat")
    
    st.header("Android Chat using AWS Bedrock")

    user_question = st.text_input("Ask a Question in android development")
    ...
    with st.sidebar:
        ...
        if st.button("Vectors Update"):
            with st.spinner("Processing..."):
                ...
                docs = data_ingestion()
                st.write("Docs loaded, count:", len(docs))
